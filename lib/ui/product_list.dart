...
import 'package:productapp/ui/bd_list.dart';
...
class _ListProductsState extends State<ListProducts> {
  ...
  Future initialize() async {
    ...
    products = List.empty();
    products = await httpHelper?.getRestaurants();
    setState(() {
      products = products;
    });
  }
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ListProducts2()),
                      );
                    },
...
class _ProductItemState extends State<ProductItem> {
  ...
  produdctIsInDb() async {
    productCount = (await dbHelper?.getProductCount()) as int;
